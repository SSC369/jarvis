export const shellStyles = "flex h-full min-h-0 w-full";
export const railStyles =
  "flex w-[236px] shrink-0 flex-col gap-[26px] border-r border-border bg-sidebar px-4 py-[26px]";
export const brandRowStyles = "flex items-center gap-2.5 px-2";
export const brandMarkStyles =
  "flex h-[27px] w-[27px] shrink-0 items-center justify-center rounded-md bg-foreground text-background";
export const wordmarkStyles = "font-mono text-[19px] font-medium tracking-[-0.015em] text-foreground";
export const wordmarkDotStyles = "text-command";
export const navStyles = "flex flex-col gap-0.5";
