...
The product is defined in [`process-docs/`](./process-docs). Every feature
moves through five gates, each one a document, each one approved before the next
begins:
...
need answers before the first feature PRD.
