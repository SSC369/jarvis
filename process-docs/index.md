...
| 002 | [Authentication](./002-authentication/) | P0, blocking | 3 Build plan | draft | Build plan drafted and verified against current Supabase docs (real Auth Hooks for sign-in/signup lockout, Google/manual merge is Supabase's default). Both §10 questions answered: FR-18 accepts Supabase's native rate limit, no custom OTP; aria-label wording follows the standard convention. Awaiting approval | 2026-09-14 |
